...
// 小装甲板
// const std::vector<cv::Point3f> SMALL_ARMOR_POINTS{
//         {-SMALL_ARMOR_WIDTH / 2, LIGHTBAR_LENGTH / 2, 0},   // 左上 (x负, y正)
//         {SMALL_ARMOR_WIDTH / 2, LIGHTBAR_LENGTH / 2, 0},    // 右上 (x正, y正)
//         {SMALL_ARMOR_WIDTH / 2, -LIGHTBAR_LENGTH / 2, 0},   // 右下 (x正, y负)
//         {-SMALL_ARMOR_WIDTH / 2, -LIGHTBAR_LENGTH / 2, 0}}; // 左下 (x负, y负)
//
// // 大装甲板同理
// const std::vector<cv::Point3f> BIG_ARMOR_POINTS{
//         {-BIG_ARMOR_WIDTH / 2, LIGHTBAR_LENGTH / 2, 0},   // 左上
//         {BIG_ARMOR_WIDTH / 2, LIGHTBAR_LENGTH / 2, 0},    // 右上
//         {BIG_ARMOR_WIDTH / 2, -LIGHTBAR_LENGTH / 2, 0},   // 右下
//         {-BIG_ARMOR_WIDTH / 2, -LIGHTBAR_LENGTH / 2, 0}}; // 左下
...
void Solver::solve(Armor & armor) const
{
  ...
  cv::solvePnP(
    ...
    cv::SOLVEPNP_ITERATIVE);//SOLVEPNP_IPPE
